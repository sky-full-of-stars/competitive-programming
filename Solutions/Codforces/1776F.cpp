...
void solve()
{
	...
	{
		// all node degree is n-1
		// I'm assuming no self cycle
		// lets isolate just 1 node with 2 colors
		// 1->2 : color 1
		// 1->x : color 2 (x != 2)
		// other: color 3
		// combine any 2 colors, we can reach all nodes
		cout << 3 << endl;
		for (auto [u, v] : paths)
		{
			if (u == 1 or v == 1)
